        ...
        <div class="d-aside-right-bar bg-grey">
            ...
            <div class="admin-content-right">
                ...
                <div class="form-container">
                    <h2 class="form-title">Register New Rule</h2>
                    <form method="POST" action="{{ route('admin.create.rule') }}"> <!-- Update the route -->
                        @csrf
                        <!-- Rule Name Field -->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="fine_amount" name="fine_amount" class="form-control" value="{{ old('fine_amount') }}" step="0.01" required>
                        </div>
            
                        <!-- Submit Button -->
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <button type="submit" class="form-submit">Register Rule</button>
                        </div>
                    </form>
                </div>
            </div>
